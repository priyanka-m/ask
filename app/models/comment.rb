...
class Comment
  ...
  referenced_in :comment_poster, :class_name => "User"
  ...
  def user_editable?(current_user)
    !current_user.nil? && (self.comment_poster == current_user || current_user.is_admin?)
  end
  ...
  def increment_comment_count
    self.comment_poster.inc(:comment_count, 1)
  end
